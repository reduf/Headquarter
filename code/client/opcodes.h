...
#define GAME_CMSG_PING_WEAPON_SET                   (0x8024) // 36
...
#define GAME_CMSG_PARTY_CANCEL_ENTER_CHALLENGE      (0x80A2) // 162
...
#define GAME_SMSG_ITEM_SALVAGE_SESSION_SUCCESS      (0x016A) // 362
