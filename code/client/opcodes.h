...
#define GAME_CMSG_DISCONNECT                        (0x8008) // 8
#define GAME_CMSG_PING_REPLY                        (0x8009) // 9
#define GAME_CMSG_HEARTBEAT                         (0x800A) // 10
#define GAME_CMSG_PING_REQUEST                      (0x800B) // 11
#define GAME_CMSG_ATTRIBUTE_DECREASE                (0x800C) // 12
#define GAME_CMSG_ATTRIBUTE_INCREASE                (0x800D) // 13
#define GAME_CMSG_ATTRIBUTE_LOAD                    (0x800E) // 14
#define GAME_CMSG_QUEST_ABANDON                     (0x800F) // 15
#define GAME_CMSG_QUEST_REQUEST_INFOS               (0x8010) // 16
#define GAME_CMSG_HERO_BEHAVIOR                     (0x8013) // 19
#define GAME_CMSG_HERO_LOCK_TARGET                  (0x8014) // 20
#define GAME_CMSG_HERO_SKILL_TOGGLE                 (0x8017) // 23
#define GAME_CMSG_HERO_FLAG_SINGLE                  (0x8018) // 24
#define GAME_CMSG_HERO_FLAG_ALL                     (0x8019) // 25
#define GAME_CMSG_HERO_USE_SKILL                    (0x801A) // 26
#define GAME_CMSG_HERO_ADD                          (0x801C) // 28
#define GAME_CMSG_HERO_KICK                         (0x801D) // 29
#define GAME_CMSG_TARGET_CALL                       (0x8021) // 33
#define GAME_CMSG_PING_WEAPON_SET                   (0x8023) // 35
#define GAME_CMSG_ATTACK_AGENT                      (0x8024) // 36
#define GAME_CMSG_CANCEL_MOVEMENT                   (0x8026) // 38
#define GAME_CMSG_DROP_BUFF                         (0x8027) // 39
#define GAME_CMSG_DRAW_MAP                          (0x8029) // 41
#define GAME_CMSG_DROP_ITEM                         (0x802A) // 42
#define GAME_CMSG_DROP_GOLD                         (0x802D) // 45
#define GAME_CMSG_EQUIP_ITEM                        (0x802E) // 46
#define GAME_CMSG_INTERACT_PLAYER                   (0x8031) // 49
#define GAME_CMSG_DEPOSIT_FACTION                   (0x8033) // 51
#define GAME_CMSG_INTERACT_LIVING                   (0x8037) // 55
#define GAME_CMSG_SEND_DIALOG                       (0x8039) // 57
#define GAME_CMSG_MOVE_TO_COORD                     (0x803C) // 60
#define GAME_CMSG_INTERACT_ITEM                     (0x803D) // 61
#define GAME_CMSG_ROTATE_PLAYER                     (0x803E) // 62
#define GAME_CMSG_CHANGE_SECOND_PROFESSION          (0x803F) // 63
#define GAME_CMSG_USE_SKILL                         (0x8044) // 68
#define GAME_CMSG_TRADE_INITIATE                    (0x8047) // 71
#define GAME_CMSG_BUY_MATERIALS                     (0x8048) // 72
#define GAME_CMSG_REQUEST_QUOTE                     (0x804A) // 74
#define GAME_CMSG_TRANSACT_ITEMS                    (0x804B) // 75
#define GAME_CMSG_UNEQUIP_ITEM                      (0x804D) // 77
#define GAME_CMSG_INTERACT_GADGET                   (0x804F) // 79
#define GAME_CMSG_OPEN_CHEST                        (0x8051) // 81
#define GAME_CMSG_TITLE_DISPLAY                     (0x8056) // 86
#define GAME_CMSG_TITLE_HIDE                        (0x8057) // 87
#define GAME_CMSG_SKILLBAR_SKILL_SET                (0x805A) // 90
#define GAME_CMSG_SKILLBAR_LOAD                     (0x805B) // 91
#define GAME_CMSG_SKILLBAR_SKILL_REPLACE            (0x805C) // 92
#define GAME_CMSG_SKIP_CINEMATIC                    (0x8061) // 97
#define GAME_CMSG_SEND_CHAT_MESSAGE                 (0x8062) // 98
#define GAME_CMSG_ITEM_DESTROY                      (0x8067) // 103
#define GAME_CMSG_ITEM_IDENTIFY                     (0x806A) // 106
#define GAME_CMSG_TOME_UNLOCK_SKILL                 (0x806B) // 107
#define GAME_CMSG_ITEM_MOVE                         (0x8070) // 112
#define GAME_CMSG_ITEM_ACCEPT_ALL                   (0x8071) // 113
#define GAME_CMSG_ITEM_SPLIT_STACK                  (0x8073) // 115
#define GAME_CMSG_ITEM_SALVAGE_SESSION_OPEN         (0x8075) // 117
#define GAME_CMSG_ITEM_SALVAGE_SESSION_CANCEL       (0x8076) // 118
#define GAME_CMSG_ITEM_SALVAGE_SESSION_DONE         (0x8077) // 119
#define GAME_CMSG_ITEM_SALVAGE_MATERIALS            (0x8078) // 120
#define GAME_CMSG_ITEM_SALVAGE_UPGRADE              (0x8079) // 121
#define GAME_CMSG_ITEM_CHANGE_GOLD                  (0x807A) // 122
#define GAME_CMSG_ITEM_USE                          (0x807C) // 124
#define GAME_CMSG_INSTANCE_LOAD_REQUEST_SPAWN       (0x8086) // 134
#define GAME_CMSG_INSTANCE_LOAD_REQUEST_PLAYERS     (0x808E) // 142
#define GAME_CMSG_INSTANCE_LOAD_REQUEST_ITEMS       (0x808F) // 143
#define GAME_CMSG_PARTY_SET_DIFFICULTY              (0x8099) // 153
#define GAME_CMSG_PARTY_ACCEPT_INVITE               (0x809A) // 154
#define GAME_CMSG_PARTY_ACCEPT_CANCEL               (0x809B) // 155
#define GAME_CMSG_PARTY_ACCEPT_REFUSE               (0x809C) // 156
#define GAME_CMSG_PARTY_INVITE_NPC                  (0x809D) // 157
#define GAME_CMSG_PARTY_INVITE_PLAYER               (0x809E) // 158
#define GAME_CMSG_PARTY_INVITE_PLAYER_NAME          (0x809F) // 159
#define GAME_CMSG_PARTY_LEAVE_GROUP                 (0x80A0) // 160
#define GAME_CMSG_PARTY_CANCEL_ENTER_CHALLENGE      (0x80A1) // 161
#define GAME_CMSG_PARTY_ENTER_CHALLENGE             (0x80A3) // 163
#define GAME_CMSG_PARTY_RETURN_TO_OUTPOST           (0x80A5) // 165
#define GAME_CMSG_PARTY_KICK_NPC                    (0x80A6) // 166
#define GAME_CMSG_PARTY_KICK_PLAYER                 (0x80A7) // 167
#define GAME_CMSG_PARTY_SEARCH_SEEK                 (0x80A8) // 168
#define GAME_CMSG_PARTY_SEARCH_CANCEL               (0x80A9) // 169
#define GAME_CMSG_PARTY_SEARCH_REQUEST_JOIN         (0x80AA) // 170
#define GAME_CMSG_PARTY_SEARCH_REQUEST_REPLY        (0x80AB) // 171
#define GAME_CMSG_PARTY_SEARCH_TYPE                 (0x80AC) // 172
#define GAME_CMSG_PARTY_READY_STATUS                (0x80AD) // 173
#define GAME_CMSG_PARTY_ENTER_GUILD_HALL            (0x80AE) // 174
#define GAME_CMSG_PARTY_TRAVEL                      (0x80AF) // 175
#define GAME_CMSG_PARTY_LEAVE_GUILD_HALL            (0x80B0) // 176
...
#define GAME_SMSG_INSTANCE_LOAD_FINISH              (0x018C) // 396
#define GAME_SMSG_INSTANCE_LOAD_SPAWN_POINT         (0x0193) // 403
#define GAME_SMSG_INSTANCE_LOAD_INFO                (0x0197) // 407
#define GAME_SMSG_TRANSFER_GAME_SERVER_INFO         (0x01A3) // 419
#define GAME_SMSG_READY_FOR_MAP_SPAWN               (0x01A9) // 425
#define GAME_SMSG_DOA_COMPLETE_ZONE                 (0x01AD) // 429
#define GAME_SMSG_INSTANCE_TRAVEL_TIMER             (0x01B9) // 441
#define GAME_SMSG_INSTANCE_CANT_ENTER               (0x01BA) // 442
#define GAME_SMSG_PARTY_SET_DIFFICULTY              (0x01BC) // 444
#define GAME_SMSG_PARTY_HENCHMAN_ADD                (0x01BD) // 445
#define GAME_SMSG_PARTY_HENCHMAN_REMOVE             (0x01BE) // 446
#define GAME_SMSG_PARTY_HERO_ADD                    (0x01C0) // 448
#define GAME_SMSG_PARTY_HERO_REMOVE                 (0x01C1) // 449
#define GAME_SMSG_PARTY_INVITE_ADD                  (0x01C2) // 450
#define GAME_SMSG_PARTY_JOIN_REQUEST                (0x01C3) // 451
#define GAME_SMSG_PARTY_INVITE_CANCEL               (0x01C4) // 452
#define GAME_SMSG_PARTY_REQUEST_CANCEL              (0x01C5) // 453
#define GAME_SMSG_PARTY_REQUEST_RESPONSE            (0x01C6) // 454
#define GAME_SMSG_PARTY_INVITE_RESPONSE             (0x01C7) // 455
#define GAME_SMSG_PARTY_YOU_ARE_LEADER              (0x01C8) // 456
#define GAME_SMSG_PARTY_PLAYER_ADD                  (0x01C9) // 457
#define GAME_SMSG_PARTY_PLAYER_REMOVE               (0x01CE) // 462
#define GAME_SMSG_PARTY_PLAYER_READY                (0x01CF) // 463
#define GAME_SMSG_PARTY_CREATE                      (0x01D0) // 464
#define GAME_SMSG_PARTY_MEMBER_STREAM_END           (0x01D1) // 465
#define GAME_SMSG_PARTY_DEFEATED                    (0x01D6) // 470
#define GAME_SMSG_PARTY_LOCK                        (0x01D7) // 471
// 474 happend when you start & stop group teleportation)
#define GAME_SMSG_PARTY_SEARCH_REQUEST_JOIN         (0x01D9) // 473
#define GAME_SMSG_PARTY_SEARCH_REQUEST_DONE         (0x01DA) // 474
#define GAME_SMSG_PARTY_SEARCH_ADVERTISEMENT        (0x01DB) // 475
#define GAME_SMSG_PARTY_SEARCH_SEEK                 (0x01DC) // 476
#define GAME_SMSG_PARTY_SEARCH_REMOVE               (0x01DD) // 477
#define GAME_SMSG_PARTY_SEARCH_SIZE                 (0x01DE) // 478
#define GAME_SMSG_PARTY_SEARCH_TYPE                 (0x01DF) // 479
