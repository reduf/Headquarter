...
#define GAME_CMSG_ATTRIBUTE_INCREASE                (0x8010) // 16
#define GAME_CMSG_ATTRIBUTE_LOAD                    (0x8011) // 17
...
#define GAME_CMSG_HERO_SKILL_TOGGLE                 (0x801B) // 27
#define GAME_CMSG_HERO_FLAG_SINGLE                  (0x801D) // 29
#define GAME_CMSG_HERO_FLAG_ALL                     (0x801E) // 30
#define GAME_CMSG_HERO_USE_SKILL                    (0x801F) // 31
#define GAME_CMSG_HERO_ADD                          (0x8021) // 33
#define GAME_CMSG_HERO_KICK                         (0x8022) // 34
#define GAME_CMSG_TARGET_CALL                       (0x8026) // 38
#define GAME_CMSG_ATTACK_AGENT                      (0x802D) // 45
#define GAME_CMSG_CANCEL_MOVEMENT                   (0x802F) // 47
#define GAME_CMSG_DROP_BUFF                         (0x8030) // 48
#define GAME_CMSG_DRAW_MAP                          (0x8032) // 50
#define GAME_CMSG_DROP_ITEM                         (0x8033) // 51
#define GAME_CMSG_DROP_GOLD                         (0x8036) // 54
#define GAME_CMSG_EQUIP_ITEM                        (0x8037) // 55
#define GAME_CMSG_INTERACT_PLAYER                   (0x803A) // 58
#define GAME_CMSG_DEPOSIT_FACTION                   (0x803C) // 60
#define GAME_CMSG_INTERACT_LIVING                   (0x8040) // 64
#define GAME_CMSG_SEND_DIALOG                       (0x8042) // 66
#define GAME_CMSG_MOVE_TO_COORD                     (0x8045) // 69
#define GAME_CMSG_INTERACT_ITEM                     (0x8046) // 70
#define GAME_CMSG_ROTATE_PLAYER                     (0x8047) // 71
#define GAME_CMSG_CHANGE_SECOND_PROFESSION          (0x8048) // 72
#define GAME_CMSG_USE_SKILL                         (0x804D) // 77
#define GAME_CMSG_TRADE_INITIATE                    (0x8050) // 80
#define GAME_CMSG_BUY_MATERIALS                     (0x8051) // 81
#define GAME_CMSG_REQUEST_QUOTE                     (0x8053) // 83
#define GAME_CMSG_TRANSACT_ITEMS                    (0x8054) // 84
#define GAME_CMSG_UNEQUIP_ITEM                      (0x8056) // 86
#define GAME_CMSG_INTERACT_GADGET                   (0x8058) // 88
#define GAME_CMSG_OPEN_CHEST                        (0x805A) // 90
#define GAME_CMSG_TITLE_DISPLAY                     (0x805F) // 95
#define GAME_CMSG_TITLE_HIDE                        (0x8060) // 96
#define GAME_CMSG_SKILLBAR_SKILL_SET                (0x8063) // 99
#define GAME_CMSG_SKILLBAR_LOAD                     (0x8064) // 100
#define GAME_CMSG_SKILLBAR_SKILL_REPLACE            (0x8065) // 101
#define GAME_CMSG_SKIP_CINEMATIC                    (0x806A) // 106
#define GAME_CMSG_SEND_CHAT_MESSAGE                 (0x806B) // 107
#define GAME_CMSG_ITEM_DESTROY                      (0x8070) // 112
#define GAME_CMSG_ITEM_IDENTIFY                     (0x8073) // 115
#define GAME_CMSG_TOME_UNLOCK_SKILL                 (0x8074) // 116
#define GAME_CMSG_ITEM_MOVE                         (0x8079) // 121
#define GAME_CMSG_ITEM_ACCEPT_ALL                   (0x807A) // 122
#define GAME_CMSG_ITEM_SPLIT_STACK                  (0x807C) // 124
#define GAME_CMSG_ITEM_SALVAGE_SESSION_OPEN         (0x807E) // 126
#define GAME_CMSG_ITEM_SALVAGE_SESSION_CANCEL       (0x807F) // 127
#define GAME_CMSG_ITEM_SALVAGE_SESSION_DONE         (0x8080) // 128
#define GAME_CMSG_ITEM_SALVAGE_MATERIALS            (0x8081) // 129
#define GAME_CMSG_ITEM_SALVAGE_UPGRADE              (0x8082) // 130
#define GAME_CMSG_ITEM_CHANGE_GOLD                  (0x8083) // 131
#define GAME_CMSG_ITEM_USE                          (0x8085) // 133
#define GAME_CMSG_INSTANCE_LOAD_REQUEST_SPAWN       (0x808F) // 143
#define GAME_CMSG_INSTANCE_LOAD_REQUEST_PLAYERS     (0x8098) // 152
#define GAME_CMSG_INSTANCE_LOAD_REQUEST_ITEMS       (0x8099) // 153
#define GAME_CMSG_PARTY_SET_DIFFICULTY              (0x80A3) // 163
#define GAME_CMSG_PARTY_ACCEPT_INVITE               (0x80A4) // 164
#define GAME_CMSG_PARTY_ACCEPT_CANCEL               (0x80A5) // 165
#define GAME_CMSG_PARTY_ACCEPT_REFUSE               (0x80A6) // 166
#define GAME_CMSG_PARTY_INVITE_NPC                  (0x80A7) // 167
#define GAME_CMSG_PARTY_INVITE_PLAYER               (0x80A8) // 168
#define GAME_CMSG_PARTY_INVITE_PLAYER_NAME          (0x80A9) // 169
#define GAME_CMSG_PARTY_LEAVE_GROUP                 (0x80AA) // 170
#define GAME_CMSG_PARTY_ENTER_CHALLENGE             (0x80AD) // 173
#define GAME_CMSG_PARTY_RETURN_TO_OUTPOST           (0x80AF) // 175
#define GAME_CMSG_PARTY_KICK_NPC                    (0x80B0) // 176
#define GAME_CMSG_PARTY_SEARCH_SEEK                 (0x80B2) // 178
#define GAME_CMSG_PARTY_SEARCH_CANCEL               (0x80B3) // 179
#define GAME_CMSG_PARTY_SEARCH_REQUEST_JOIN         (0x80B4) // 180
#define GAME_CMSG_PARTY_SEARCH_REQUEST_REPLY        (0x80B5) // 181
#define GAME_CMSG_PARTY_SEARCH_TYPE                 (0x80B6) // 182
#define GAME_CMSG_PARTY_READY_STATUS                (0x80B7) // 183
#define GAME_CMSG_PARTY_ENTER_GUILD_HALL            (0x80B8) // 184
#define GAME_CMSG_PARTY_TRAVEL                      (0x80B9) // 185
#define GAME_CMSG_PARTY_LEAVE_GUILD_HALL            (0x80BA) // 186
