...
#define GAME_CMSG_COUNT (200)
#define GAME_SMSG_COUNT (492)
...
#define GAME_CMSG_PING_REPLY                        (0x800B) // 11
#define GAME_CMSG_HEARTBEAT                         (0x800C) // 12
#define GAME_CMSG_PING_REQUEST                      (0x800D) // 13
#define GAME_CMSG_ATTRIBUTE_DECREASE                (0x800E) // 14
#define GAME_CMSG_ATTRIBUTE_INCREASE                (0x800F) // 15
#define GAME_CMSG_ATTRIBUTE_LOAD                    (0x8010) // 16
#define GAME_CMSG_QUEST_ABANDON                     (0x8012) // 18
#define GAME_CMSG_QUEST_REQUEST_INFOS               (0x8013) // 19
#define GAME_CMSG_HERO_BEHAVIOR                     (0x8017) // 23
#define GAME_CMSG_HERO_LOCK_TARGET                  (0x8018) // 24
#define GAME_CMSG_HERO_SKILL_TOGGLE                 (0x801C) // 28
#define GAME_CMSG_HERO_FLAG_SINGLE                  (0x801E) // 30
#define GAME_CMSG_HERO_FLAG_ALL                     (0x801F) // 31
#define GAME_CMSG_HERO_USE_SKILL                    (0x8020) // 32
#define GAME_CMSG_HERO_ADD                          (0x8023) // 35
#define GAME_CMSG_HERO_KICK                         (0x8024) // 36
#define GAME_CMSG_TARGET_CALL                       (0x8028) // 40
#define GAME_CMSG_ATTACK_AGENT                      (0x802C) // 44
#define GAME_CMSG_CANCEL_MOVEMENT                   (0x802E) // 46
#define GAME_CMSG_DROP_BUFF                         (0x802F) // 47
#define GAME_CMSG_DROP_ITEM                         (0x8032) // 50
#define GAME_CMSG_DROP_GOLD                         (0x8035) // 53
#define GAME_CMSG_EQUIP_ITEM                        (0x8036) // 54
#define GAME_CMSG_INTERACT_PLAYER                   (0x8039) // 57
#define GAME_CMSG_DEPOSIT_FACTION                   (0x803B) // 59
#define GAME_CMSG_INTERACT_LIVING                   (0x803F) // 63
#define GAME_CMSG_SEND_DIALOG                       (0x8041) // 65
#define GAME_CMSG_MOVE_TO_COORD                     (0x8044) // 68
#define GAME_CMSG_INTERACT_ITEM                     (0x8045) // 69
#define GAME_CMSG_ROTATE_PLAYER                     (0x8046) // 70
#define GAME_CMSG_CHANGE_SECOND_PROFESSION          (0x8047) // 71
#define GAME_CMSG_USE_SKILL                         (0x804C) // 76
#define GAME_CMSG_TRADE_INITIATE                    (0x804F) // 79
#define GAME_CMSG_BUY_MATERIALS                     (0x8050) // 80
#define GAME_CMSG_REQUEST_QUOTE                     (0x8052) // 82
#define GAME_CMSG_TRANSACT_ITEMS                    (0x8053) // 83
#define GAME_CMSG_UNEQUIP_ITEM                      (0x8055) // 85
#define GAME_CMSG_INTERACT_GADGET                   (0x8057) // 87
#define GAME_CMSG_OPEN_CHEST                        (0x8059) // 89
#define GAME_CMSG_TITLE_DISPLAY                     (0x805E) // 94
#define GAME_CMSG_TITLE_HIDE                        (0x805F) // 95
#define GAME_CMSG_SKILLBAR_SKILL_SET                (0x8062) // 98
#define GAME_CMSG_SKILLBAR_LOAD                     (0x8063) // 99
#define GAME_CMSG_SKILLBAR_SKILL_REPLACE            (0x8064) // 100
#define GAME_CMSG_SKIP_CINEMATIC                    (0x8069) // 105
#define GAME_CMSG_SEND_CHAT_MESSAGE                 (0x806A) // 106
#define GAME_CMSG_ITEM_DESTROY                      (0x806F) // 111
#define GAME_CMSG_ITEM_IDENTIFY                     (0x8072) // 114
#define GAME_CMSG_TOME_UNLOCK_SKILL                 (0x8073) // 115
#define GAME_CMSG_ITEM_MOVE                         (0x8078) // 120
#define GAME_CMSG_ITEM_ACCEPT_ALL                   (0x8079) // 121
#define GAME_CMSG_ITEM_SPLIT_STACK                  (0x807B) // 123
#define GAME_CMSG_ITEM_SALVAGE_SESSION_OPEN         (0x807D) // 125
#define GAME_CMSG_ITEM_SALVAGE_SESSION_CANCEL       (0x807E) // 126
#define GAME_CMSG_ITEM_SALVAGE_SESSION_DONE         (0x807F) // 127
#define GAME_CMSG_ITEM_SALVAGE_MATERIALS            (0x8080) // 128
#define GAME_CMSG_ITEM_SALVAGE_UPGRADE              (0x8081) // 129
#define GAME_CMSG_ITEM_CHANGE_GOLD                  (0x8082) // 130
#define GAME_CMSG_ITEM_USE                          (0x8084) // 132
#define GAME_CMSG_INSTANCE_LOAD_REQUEST_SPAWN       (0x808E) // 142
#define GAME_CMSG_INSTANCE_LOAD_REQUEST_PLAYERS     (0x8097) // 151
#define GAME_CMSG_INSTANCE_LOAD_REQUEST_ITEMS       (0x8098) // 152
#define GAME_CMSG_PARTY_SET_DIFFICULTY              (0x80A2) // 162
#define GAME_CMSG_PARTY_ACCEPT_INVITE               (0x80A3) // 163
#define GAME_CMSG_PARTY_ACCEPT_CANCEL               (0x80A4) // 164
#define GAME_CMSG_PARTY_ACCEPT_REFUSE               (0x80A5) // 165
#define GAME_CMSG_PARTY_INVITE_NPC                  (0x80A6) // 166
#define GAME_CMSG_PARTY_INVITE_PLAYER               (0x80A7) // 167
#define GAME_CMSG_PARTY_INVITE_PLAYER_NAME          (0x80A8) // 168
#define GAME_CMSG_PARTY_LEAVE_GROUP                 (0x80A9) // 169
#define GAME_CMSG_PARTY_ENTER_CHALLENGE             (0x80AC) // 172
#define GAME_CMSG_PARTY_RETURN_TO_OUTPOST           (0x80AE) // 174
#define GAME_CMSG_PARTY_KICK_NPC                    (0x80AF) // 175
#define GAME_CMSG_PARTY_SEARCH_SEEK                 (0x80B1) // 177
#define GAME_CMSG_PARTY_SEARCH_CANCEL               (0x80B2) // 178
#define GAME_CMSG_PARTY_SEARCH_REQUEST_JOIN         (0x80B3) // 179
#define GAME_CMSG_PARTY_SEARCH_REQUEST_REPLY        (0x80B4) // 180
#define GAME_CMSG_PARTY_SEARCH_TYPE                 (0x80B5) // 181
#define GAME_CMSG_PARTY_READY_STATUS                (0x80B6) // 182
#define GAME_CMSG_PARTY_ENTER_GUILD_HALL            (0x80B7) // 183
#define GAME_CMSG_PARTY_TRAVEL                      (0x80B8) // 184
#define GAME_CMSG_PARTY_LEAVE_GUILD_HALL            (0x80B9) // 185
...
#define GAME_SMSG_INSTANCE_SHOW_WIN                 (0x0180) // 384
#define GAME_SMSG_INSTANCE_LOAD_HEAD                (0x0181) // 385
#define GAME_SMSG_INSTANCE_LOAD_PLAYER_NAME         (0x0182) // 386
#define GAME_SMSG_INSTANCE_COUNTDOWN_STOP           (0x0184) // 388
#define GAME_SMSG_INSTANCE_COUNTDOWN                (0x0186) // 390
#define GAME_SMSG_INSTANCE_LOAD_FINISH              (0x0193) // 403
#define GAME_SMSG_INSTANCE_LOAD_SPAWN_POINT         (0x019A) // 410
#define GAME_SMSG_INSTANCE_LOAD_INFO                (0x019E) // 414
#define GAME_SMSG_TRANSFER_GAME_SERVER_INFO         (0x01AA) // 426
#define GAME_SMSG_READY_FOR_MAP_SPAWN               (0x01B0) // 432
// #define GAME_SMSG_                               (0x0155) // 341
#define GAME_SMSG_INSTANCE_TRAVEL_TIMER             (0x01C0) // 448
#define GAME_SMSG_INSTANCE_CANT_ENTER               (0x01C1) // 449
#define GAME_SMSG_PARTY_SET_DIFFICULTY              (0x01C3) // 451
#define GAME_SMSG_PARTY_HENCHMAN_ADD                (0x01C4) // 452
#define GAME_SMSG_PARTY_HENCHMAN_REMOVE             (0x01C5) // 453
#define GAME_SMSG_PARTY_HERO_ADD                    (0x01C7) // 455
#define GAME_SMSG_PARTY_HERO_REMOVE                 (0x01C8) // 456
#define GAME_SMSG_PARTY_INVITE_ADD                  (0x01C9) // 457
#define GAME_SMSG_PARTY_JOIN_REQUEST                (0x01CA) // 458
#define GAME_SMSG_PARTY_INVITE_CANCEL               (0x01CB) // 459
#define GAME_SMSG_PARTY_REQUEST_CANCEL              (0x01CC) // 460
#define GAME_SMSG_PARTY_YOU_ARE_LEADER              (0x01CF) // 463
#define GAME_SMSG_PARTY_PLAYER_ADD                  (0x01D0) // 464
#define GAME_SMSG_PARTY_PLAYER_REMOVE               (0x01D5) // 469
#define GAME_SMSG_PARTY_PLAYER_READY                (0x01D6) // 470
#define GAME_SMSG_PARTY_CREATE                      (0x01D7) // 471
#define GAME_SMSG_PARTY_MEMBER_STREAM_END           (0x01D8) // 472
#define GAME_SMSG_PARTY_DEFEATED                    (0x01DD) // 477
// 474 happend when you start & stop group teleportation)
#define GAME_SMSG_PARTY_SEARCH_REQUEST_JOIN         (0x01E0) // 480
#define GAME_SMSG_PARTY_SEARCH_REQUEST_DONE         (0x01E1) // 481
#define GAME_SMSG_PARTY_SEARCH_ADVERTISEMENT        (0x01E2) // 482
#define GAME_SMSG_PARTY_SEARCH_SEEK                 (0x01E3) // 483
#define GAME_SMSG_PARTY_SEARCH_REMOVE               (0x01E4) // 484
#define GAME_SMSG_PARTY_SEARCH_SIZE                 (0x01E5) // 485
#define GAME_SMSG_PARTY_SEARCH_TYPE                 (0x01E7) // 487
